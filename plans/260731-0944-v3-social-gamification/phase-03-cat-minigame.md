...
- [x] `src/lib/cat/compute-cat-mood.ts` — pure function
- [x] `src/app/api/cat/route.ts` — GET state + mood
- [x] `src/app/api/cat/feed/route.ts` — deduct 5 pts
- [x] `src/app/api/cat/bath/route.ts` — deduct 10 pts
- [x] `src/app/api/cat/pet/route.ts` — free, max 3/day
- [x] `src/app/api/cat/play/route.ts` — deduct 15 pts
- [x] `src/app/api/cron/cat-decay/route.ts` — batch decay
- [x] `src/components/cat/cat-sprite.tsx` — CSS art 6 states
- [x] `src/components/cat/cat-widget.tsx` — floating 80px
- [x] `src/components/cat/cat-game-modal.tsx` — full modal
- [x] `vercel.json` — cron schedule
- [x] `.env` — thêm `CRON_SECRET`
